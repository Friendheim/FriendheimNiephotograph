...
export const site = {
  ...
  about: {
    philosophy: [
      'Photography came to me quietly, the way the best things usually do — somewhere between lectures and the long walks I take to learn a new city. Three years in, I am still learning to see. My work favours the small, honest moments: a folded hand, light crossing a wall, a street that is almost empty. I try not to interrupt the world, only to notice it more carefully.',
